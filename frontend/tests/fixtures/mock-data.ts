...
// Shared with tests/mock-api-server.mjs via genre-synthesis.fixture.json so
// the SSR and browser-side mocks stay in lockstep. The fixture is sized to
// meet the page's structural assertions (10 friction, 10 wishlist, 5
// benchmarks, ≥3 dev priorities).
// ---------------------------------------------------------------------------

import genreSynthesisFixture from './genre-synthesis.fixture.json'

export const MOCK_GENRE_SYNTHESIS = genreSynthesisFixture
