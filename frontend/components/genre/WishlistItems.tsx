...
export function WishlistItems({ items, inputCount, appidToName }: Props) {
  return (
    <section aria-labelledby="wishlist-heading" className="mb-14">
      <h2
        id="wishlist-heading"
        className="font-serif text-2xl md:text-3xl font-semibold mb-2"
        style={{ letterSpacing: "-0.02em" }}
      >
        Top {items.length} Wishlist Features
      </h2>
      <p className="text-sm text-muted-foreground font-mono mb-6">
        What players are already asking for. Each item is an opportunity, not a complaint.
      </p>
