...
// Genre synthesis routes live in tests/mock-api-server.mjs because the
// /genre/[slug]/ page is a server component — page.route() only intercepts
// browser-side fetches. Add a browser-side helper here only when a genre
// feature starts making client-side fetches.
