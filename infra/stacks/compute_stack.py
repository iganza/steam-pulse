...
class ComputeStack(cdk.Stack):
    def __init__(
        ...
        **kwargs: object,
        ...
        # Daily catalog refresh at 06:15 UTC — fetches Steam GetAppList, upserts
        # new apps, and enqueues any pending metadata crawls. Also the sole
        # trigger for matview refresh (1 cycle/day).
