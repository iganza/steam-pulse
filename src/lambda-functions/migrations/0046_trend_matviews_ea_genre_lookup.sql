...
-- Replace the ea_flags CTE (full reviews table scan) with a genre 70 lookup
-- on game_genres, which is small and indexed. This eliminates the reviews
-- table from every trend matview refresh.
--
-- Drop + recreate is required because the CTE is embedded in the matview DDL.
