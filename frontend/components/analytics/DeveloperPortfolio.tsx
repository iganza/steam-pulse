...
export function DeveloperPortfolio({ data }: DeveloperPortfolioProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{data.developer}</CardTitle>
        <p className="text-xs text-muted-foreground">Developer portfolio overview</p>
      </CardHeader>
      <CardContent>
        {/* Summary stat cards */}
...
function GameCard({ game }: { game: DeveloperGame }) {
