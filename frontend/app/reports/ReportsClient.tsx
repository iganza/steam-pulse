...
import { getCatalogReports } from "@/lib/api";
import type { CatalogReportEntry, CatalogReportsResponse } from "@/lib/types";
...
export function ReportsClient() {
  ...
  const updateUrl = useCallback((params: Record<string, string | undefined>) => {
    ...
    if ("sort" in params || "genre" in params || "tag" in params) {
      sp.delete("page");
    }
  ...
  const pageSize = reportsData?.page_size ?? PER_PAGE;
