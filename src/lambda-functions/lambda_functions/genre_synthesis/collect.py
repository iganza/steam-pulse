...
logger = Logger(service="genre-synthesis-collect")
tracer = Tracer(service="genre-synthesis-collect")
metrics = Metrics(namespace="SteamPulse", service="genre-synthesis-collect")
