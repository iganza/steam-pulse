...
import MOCK_GENRE_SYNTHESIS from './fixtures/genre-synthesis.fixture.json' with { type: 'json' }
...
// Genre synthesis fixture is imported at the top of this file from the
// shared JSON payload so the .ts fixture and this .mjs server render the
// exact same body.
