    ...
    route.fulfill({
      json: {
        ...
        game: {
          ...
          // 0048: English-only post-release split
          review_count_post_release: MOCK_GAME_ANALYZED.review_count_post_release,
          positive_count_post_release: MOCK_GAME_ANALYZED.positive_count_post_release,
          positive_pct_post_release: MOCK_GAME_ANALYZED.positive_pct_post_release,
          review_score_desc_post_release: MOCK_GAME_ANALYZED.review_score_desc_post_release,
          has_early_access_reviews: MOCK_GAME_ANALYZED.has_early_access_reviews,
          coming_soon: MOCK_GAME_ANALYZED.coming_soon,
